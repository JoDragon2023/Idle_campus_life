...
namespace Suriyun.MCS {
    ...
    public class UIScalerInspector : Editor {
        ...
        protected SerializedProperty preferredScaleFactor;
        ...
        protected virtual void OnEnable() {
            ...
            preferredScaleFactor = serializedObject.FindProperty("preferredScaleFactor");
        }
        ...
        public override void OnInspectorGUI() {
            ...
            EditorGUILayout.PropertyField(preferredScaleFactor);
