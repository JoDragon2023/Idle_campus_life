    ...
    public class CameraBase : MonoBehaviour, ITouchCamera
    {
        ...
        protected Vector3 ClampCameraCorners(Vector3 finalPosition, out bool clampApplied, bool bottomEdges = true, bool topEdges = true)
        {
            ...
            if (bottomEdges)
            {
                ...
                Vector3 worldPointBottomLeftClamped = ClampInCameraBoundaries(worldPointBottomLeft);
                ...
                Vector3 worldPointBottomRightClamped = ClampInCameraBoundaries(worldPointBottomRight);
            ...
            if (topEdges)
            {
                ...
                Vector3 worldPointTopRightClamped = ClampInCameraBoundaries(worldPointTopRight);
        ...
        public void MoveCameraToInstant(float targetDistanceOrSize)
        {
        ...
        /// <param name="targetDistanceOrSize"></param>
        public void MoveCameraToInstant(Vector3 targetOffset, float targetDistanceOrSize)
        {
            //FocusCamera(targetPosition, targetDistanceOrSize, true);
            finalOffset = ClampInCameraBoundaries(targetOffset);
            finalDistance = CalculateClampedDistance(targetDistanceOrSize);
        ...
        public void MoveCameraToInstant(Vector3 targetOffset, Vector2 targetRotation)
        {
        ...
        /// <param name="targetOffset"></param>
        /// <param name="targetRotation"></param>
        public void MoveCameraToInstant(Vector3 targetOffset, Quaternion targetRotation)
        {
        ...
        /// <param name="targetDistanceOrSize"></param>
        /// <param name="targetRotation"></param>
        public void MoveCameraToInstant(Vector3 targetOffset, float targetDistanceOrSize, Vector2 targetRotation)
        {
        ...
        /// <param name="targetDistanceOrSize"></param>
        /// <param name="targetRotation"></param>
        public void MoveCameraToInstant(Vector3 targetOffset, float targetDistanceOrSize, Quaternion targetRotation)
        {
        ...
        virtual protected void CalculateInertia()
        {
            ...
            rotationAcceleration.AddPosition(new Vector2(currentPitch, currentYaw));
